...
static void show_banks(void)
{
  ...
  while((dt_read8[i].mem_handler!=NULL)||(dt_read8[i].data!=NULL))
  {
    ...
    else if ((dt_read8[i].mem_handler)&&(!dt_read8[i].data))
    {
  ...
  while((dt_write8[i].mem_handler!=NULL)||(dt_write8[i].data!=NULL))
  {
    ...
    else if ((dt_write8[i].mem_handler)&&(!dt_write8[i].data))
    {
...
#define FINISH_SEARCH_READWRITE(_R_OR_W_) \
  ...
  unsigned fame_get_reg(int regnum)
  {
    switch( regnum )
    {
      case M68K_ISP:
      case M68K_USP:
        return famem68k_get_register(M68K_REG_ASP);
      case M68K_SR:
        return famem68k_get_register(M68K_REG_SR);
      case M68K_D0:
        return famem68k_get_register(M68K_REG_D0);
      case M68K_D1:
        return famem68k_get_register(M68K_REG_D1);
      case M68K_D2:
        return famem68k_get_register(M68K_REG_D2);
      case M68K_D3:
        return famem68k_get_register(M68K_REG_D3);
      case M68K_D4:
        return famem68k_get_register(M68K_REG_D4);
      case M68K_D5:
        return famem68k_get_register(M68K_REG_D5);
      case M68K_D6:
        return famem68k_get_register(M68K_REG_D6);
      case M68K_D7:
        return famem68k_get_register(M68K_REG_D7);
      case M68K_A0:
        return famem68k_get_register(M68K_REG_A0);
      case M68K_A1:
        return famem68k_get_register(M68K_REG_A1);
      case M68K_A2:
        return famem68k_get_register(M68K_REG_A2);
      case M68K_A3:
        return famem68k_get_register(M68K_REG_A3);
      case M68K_A4:
        return famem68k_get_register(M68K_REG_A4);
      case M68K_A5:
        return famem68k_get_register(M68K_REG_A5);
      case M68K_A6:
        return famem68k_get_register(M68K_REG_A6);
      case M68K_SP:
      case M68K_A7:
        return famem68k_get_register(M68K_REG_A7);
      case M68K_PREF_ADDR:
...
//					return cpu_readmem24bew_dword( offset );
  ...
  void fame_set_reg(int regnum, unsigned val)
  {
    switch( regnum )
    {
      ...
      case M68K_ISP:
      case M68K_USP:
        famem68k_set_register(M68K_REG_ASP, val);
        break;
      case M68K_SR:
        famem68k_set_register(M68K_REG_SR, val);
        break;
      case M68K_D0:
        famem68k_set_register(M68K_REG_D0, val);
        break;
      case M68K_D1:
        famem68k_set_register(M68K_REG_D1, val);
        break;
      case M68K_D2:
        famem68k_set_register(M68K_REG_D2, val);
        break;
      case M68K_D3:
        famem68k_set_register(M68K_REG_D3, val);
        break;
      case M68K_D4:
        famem68k_set_register(M68K_REG_D4, val);
        break;
      case M68K_D5:
        famem68k_set_register(M68K_REG_D5, val);
        break;
      case M68K_D6:
        famem68k_set_register(M68K_REG_D6, val);
        break;
      case M68K_D7:
        famem68k_set_register(M68K_REG_D7, val);
        break;
      case M68K_A0:
        famem68k_set_register(M68K_REG_A0, val);
        break;
      case M68K_A1:
        famem68k_set_register(M68K_REG_A1, val);
        break;
      case M68K_A2:
        famem68k_set_register(M68K_REG_A2, val);
        break;
      case M68K_A3:
        famem68k_set_register(M68K_REG_A3, val);
        break;
      case M68K_A4:
        famem68k_set_register(M68K_REG_A4, val);
        break;
      case M68K_A5:
        famem68k_set_register(M68K_REG_A5, val);
        break;
      case M68K_A6:
        famem68k_set_register(M68K_REG_A6, val);
        break;
      case M68K_SP:
      case M68K_A7:
        famem68k_set_register(M68K_REG_A7, val);
...
//					cpu_writemem24bew_word( offset, val );
  ...
  const char *fame_info(void *context, int regnum)
  {
    ...
    {
      case CPU_INFO_NAME:
        return "FAME (Fast & Accurate Motorola 68000)";
      ...
      case CPU_INFO_CREDITS:
        return "Copyright Oscar Orallo Pelaez & Stèphane Dallongueville. All rights reserved";
    }
    return "";
  }
