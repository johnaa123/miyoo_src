...
static void init_palette_montecar(unsigned char *game_palette, unsigned short *game_colortable,const unsigned char *color_prom)
{
  ...
  prom_to_palette(game_palette, p[0x100]);
  game_palette+=3;
  prom_to_palette(game_palette, p[0x101]);
  game_palette+=3;
  prom_to_palette(game_palette, p[0x102]);
  game_palette+=3;
  prom_to_palette(game_palette, p[0x103]);
  game_palette+=3;

  prom_to_palette(game_palette, p[0x100]);
  game_palette+=3;
  prom_to_palette(game_palette, p[0x110]);
  game_palette+=3;
  prom_to_palette(game_palette, p[0x120]);
  game_palette+=3;
  prom_to_palette(game_palette, p[0x130]);
  game_palette+=3;

  prom_to_palette(game_palette, p[0x100]);
  game_palette+=3;
  prom_to_palette(game_palette, p[0x104]);
  game_palette+=3;
  prom_to_palette(game_palette, p[0x108]);
  game_palette+=3;
  prom_to_palette(game_palette, p[0x10C]);
  game_palette+=3;

  prom_to_palette(game_palette, p[0x140]);
  game_palette+=3;
  prom_to_palette(game_palette, p[0x144]);
  game_palette+=3;
  prom_to_palette(game_palette, p[0x148]);
  game_palette+=3;
  prom_to_palette(game_palette, p[0x14C]);
  game_palette+=3;

  prom_to_palette(game_palette, p[0x180]);
  game_palette+=3;
  prom_to_palette(game_palette, p[0x184]);
  game_palette+=3;
  prom_to_palette(game_palette, p[0x188]);
  game_palette+=3;
  prom_to_palette(game_palette, p[0x18C]);
  game_palette+=3;

  prom_to_palette(game_palette, p[0x1C0]);
  game_palette+=3;
  prom_to_palette(game_palette, p[0x1C4]);
  game_palette+=3;
  prom_to_palette(game_palette, p[0x1C8]);
  game_palette+=3;
  prom_to_palette(game_palette, p[0x1CC]);
  game_palette+=3;
