      ...
      if(flipscreen[1])
      {
        switch(n)
        {
          case 0:
            ...
            break;
          case 1:
            scrollx[32*8-i] = kikstart_scrollram[i]+((taitosj_scroll[2*n]+0xa)&0xff);
            break;
          case 2:
            scrollx[32*8-i] = kikstart_scrollram[0x100+i]+((taitosj_scroll[2*n]+0xc)&0xff);
            break;
        }
      }
      else
      {
        switch(n)
        {
          case 0:
            ...
            break;
          case 1:
            scrollx[i] = 0xff-kikstart_scrollram[i-1]-((taitosj_scroll[2*n]-0x10)&0xff);
            break;
          case 2:
            scrollx[i] = 0xff-kikstart_scrollram[0x100+i-1]-((taitosj_scroll[2*n]-0x12)&0xff);
            break;
        }
      }
    }
