...
int osd_is_joy_pressed(int joycode)
{
  ...
  else
  {
    ...
    {
      case 0:
        return is_joy_axis_pressed(axis, dir, ExKey1);
        break;
      case 1:
        return is_joy_axis_pressed(axis, dir, ExKey2);
        break;
      case 2:
        return is_joy_axis_pressed(axis, dir, ExKey3);
        break;
      case 3:
        return is_joy_axis_pressed(axis, dir, ExKey4);
        break;
      default:
        break;
    }
