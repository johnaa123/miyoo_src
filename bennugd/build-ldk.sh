...
TARGET=mipsel-linux
BUILD=`uname -m`
PKG_CONFIG_PATH=/opt/ldk/mipsel-buildroot-linux-uclibc/sysroot/usr/lib/pkgconfig
...
CFLAGS="-DTARGET_MIYOO -O3 -I/opt/ldk/mipsel-buildroot-linux-uclibc/sysroot/usr/include/SDL"
