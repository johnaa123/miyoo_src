...
private:
  ...
  public:
    ...
    {
      return static_cast<ScalingMethod>(static_cast<int>(scaling_));
    }
  };
...
public:
  ...
  ScalingMethod scalingMethod() const
  {
    return scalingMethodSelector.scalingMethod();
  }
