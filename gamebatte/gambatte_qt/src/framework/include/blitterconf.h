...
public:
  ...
  bool operator==(ConstBlitterConf r) const
  {
    return blitter == r.blitter;
  }
  bool operator!=(ConstBlitterConf r) const
  {
    return blitter != r.blitter;
...
public:
  ...
  bool operator==(BlitterConf r) const
  {
    return blitter == r.blitter;
  }
  bool operator!=(BlitterConf r) const
  ...
  operator const ConstBlitterConf() const
  {
    return ConstBlitterConf(blitter);
  }
};
