...
public:
  ...
  ~MiscDialog();
  int turboSpeed() const
  {
    return turboSpeed_;
  }
  bool pauseOnDialogs() const
  {
    return pauseOnDialogs_.value() | pauseOnFocusOut_.value();
  }
  bool pauseOnFocusOut() const
  {
    return pauseOnFocusOut_.value();
  }
  bool dwmTripleBuf() const
  {
    return dwmTripleBuf_.value();
  }
  bool multicartCompat() const
  {
    return multicartCompat_.value();
  }
  const QSize & baseFps() const
  {
    return fpsSelector_.value();
  }
  const QString & savePath() const
  {
    return savepathSelector_.value();
  }
