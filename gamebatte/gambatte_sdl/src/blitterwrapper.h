...
public:
  struct Buf
  {
    gambatte::uint_least32_t* pixels;
    unsigned pitch;
  };
  ...
  void setScale(const Uint8 scale)
  {
    blitter.setScale(scale);
  }
  void setStartFull()
  {
    blitter.setStartFull();
  }
  void setYuv(const bool yuv)
  {
    blitter.setYuv(yuv);
  }
  ...
  void setScaler(const int scaler)
  {
    blitter.setScaler(scaler);
  }
  int getScaler()
  {
    return blitter.getScaler();
  }
  void init();
};
